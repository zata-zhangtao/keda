...
from backend.engines.agent_runner.live_terminal import _AgentPanelState
...
def test_agent_panel_state_joins_fragmented_chunks_on_current_line() -> None:
    ...
    panel_state = _AgentPanelState("synthesizer", "claude")
...
def test_agent_panel_state_splits_only_on_real_newlines() -> None:
    ...
    panel_state = _AgentPanelState("skeptic", "kimi")
