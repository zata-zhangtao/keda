...
import { getCurrentSession, login, logout } from "@/lib/api/auth";
...
/** 提供全局会话状态（loading/authenticated/anonymous/error）与 sessionStorage 缓存。 */
...
/** 读取当前会话上下文；必须在 SessionProvider 内部使用。 */
