...
reuse_command = "just worktree --issue {issue_number} --existing-branch enter_shell=false"
path_command = "bash scripts/git_worktree.sh --print-path --issue {issue_number} --existing-branch"
